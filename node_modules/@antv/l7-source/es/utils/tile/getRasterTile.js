      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            if (cfg.wmtsOptions) {
              imageUrl = getWMTSURLFromTemplate(templateUrl, _objectSpread(_objectSpread({}, tileParams), cfg.wmtsOptions));
            } else {
              imageUrl = getURLFromTemplate(Array.isArray(url) ? url[0] : url, tileParams);
            }
